...
export default function DeveloperMeeting() {
    ...
    <div>
      ...
      <div style={{ padding: '20px' }}>
        <div style={{ background: 'white', padding: '20px', border: '1px solid #ddd', borderRadius: '4px' }}>
          ...
          <p>Developers can join meetings but cannot schedule them.</p>
          <Link href="/developerdashboard/projects/view" style={{ color: '#007bff', textDecoration: 'none' }}>← Back to Project View</Link>
        </div>
      </div>
    </div>
  );
