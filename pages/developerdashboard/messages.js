    ...
    <div>
      <nav style={{ background: '#343a40', color: 'white', padding: '15px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
          ...
          <Link href="/developerdashboard/messages" style={{ color: 'white', textDecoration: 'none', padding: '8px 16px', borderRadius: '4px', background: '#495057' }}>Messages</Link>
      ...
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            {['allRoles', 'testers', 'projectManager', 'directors', 'crm', 'clients'].map(role => (
              <button 
                key={role}
