...
export default function CRMMeeting() {
    ...
    <div>
      ...
      <div style={{ padding: '20px' }}>
        <div style={{ background: 'white', padding: '20px', border: '1px solid #ddd', borderRadius: '4px' }}>
          ...
          <p>CRM users can view meeting details but cannot schedule meetings.</p>
          <Link href="/crmdashboard/projects/view" style={{ color: '#007bff', textDecoration: 'none' }}>← Back to Project View</Link>
        </div>
      </div>
    </div>
  );
