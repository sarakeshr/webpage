    ...
    <div>
      <nav style={{ background: '#343a40', color: 'white', padding: '15px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '20px' }}>
          <Link href="/director/projects" style={{ color: 'white', textDecoration: 'none', padding: '8px 16px', borderRadius: '4px' }}>Projects</Link>
          <Link href="/director/messages" style={{ color: 'white', textDecoration: 'none', padding: '8px 16px', borderRadius: '4px', background: '#495057' }}>Messages</Link>
      ...
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            {['allRoles', 'developers', 'testers', 'projectManager', 'crm', 'directors'].map(role => (
              <button 
                key={role}
