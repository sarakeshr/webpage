...
export default function TesterMessages() {
  ...
  const teamMembers = {
    ...
    clients: [
      { name: 'John Client', projects: [1, 2, 3, 5] }
    ]
  };
    ...
    <div>
      <nav style={{ background: '#343a40', color: 'white', padding: '15px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
          ...
          <Link href="/testerdashboard/messages" style={{ color: 'white', textDecoration: 'none', padding: '8px 16px', borderRadius: '4px', background: '#495057' }}>Messages</Link>
      ...
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            {['allRoles', 'developers', 'projectManager', 'directors', 'crm', 'clients'].map(role => (
              <button 
                key={role}
